...
function check_ca0() {
	...
	ls -l /etc/hyperledger/fabric-ca-server-config/e7cde8e89b6c031d4e275ee18ab80de9b73b0caf89e392fc1eb1047dd61e0200_sk
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/e7cde8e89b6c031d4e275ee18ab80de9b73b0caf89e392fc1eb1047dd61e0200_sk
	
	fabric-ca-server start -n ca0 ${V11_IDENTITIES_ALLOWREMOVE} ${V11_AFFILIATIONS_ALLOWREMOVE} --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/e7cde8e89b6c031d4e275ee18ab80de9b73b0caf89e392fc1eb1047dd61e0200_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/e7cde8e89b6c031d4e275ee18ab80de9b73b0caf89e392fc1eb1047dd61e0200_sk -d
}


function check_ca1() {
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/52c15249bb7e070319eaaff80c1cde4f3fb2871a818e78084e232db306faa81e_sk
	
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/52c15249bb7e070319eaaff80c1cde4f3fb2871a818e78084e232db306faa81e_sk
	
	fabric-ca-server start --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/52c15249bb7e070319eaaff80c1cde4f3fb2871a818e78084e232db306faa81e_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/52c15249bb7e070319eaaff80c1cde4f3fb2871a818e78084e232db306faa81e_sk -d
}
